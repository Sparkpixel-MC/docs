...
export default defineUserConfig({
  ...
  locales: {
    '/': {
      ...
      lang: 'zh-CN',
      description: 'Sparkpixel Server Helpful Docs',
    },
    '/en/': {
      title: 'Sparkpixel Server Wiki',
      lang: 'en-US',
  ...
  plugins: [
    ...
    markdownContainerPlugin({ type: 'tip' }),
    markdownContainerPlugin({ type: 'warning' }),
    markdownContainerPlugin({ type: 'danger' }),
    markdownContainerPlugin({ type: 'info' }),
    markdownContainerPlugin({ type: 'details' }),
    markdownExtPlugin({
      code: true,
      tasklist: true,
    }),
    ...
    photoSwipePlugin({
      selector: 'img:not(.item-image):not(.output-image):not(.any-planks-anim)',
      locales: {
        '/': {
          close: '关闭',
          download: '下载',
    ...
    watermarkPlugin({
      enabled: true,
      content: 'Sparkpixel Server Wiki',
      options: {
